...
print #####_Custom_output_##### Av BW BW_2 Rout gm_M1 ro_M1 gm_M6 ro_M6 ro_M4 gm_M8 ro_M8 ro_M10
    ...
    remzerovec
    write error_amplifier_N_input_core_v4_ac.raw
    set appendwrite
    ...
    *plot vout_phase
    ...
    write error_amplifier_N_input_core_v4_TB_os_v3.raw
.endc
"}
...
C {gf180/error_amplifier_N_input_core_v4/xschem/error_amplifier_N_input_core_v4.sym} 530 -570 0 0 {name=x1}
