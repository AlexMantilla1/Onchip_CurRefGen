...
N 520 -410 560 -410 {lab=Vref}
N 680 -490 680 -450 {lab=VDD}
N 970 -170 1010 -170 {lab=VDD}
N 970 -130 1010 -130 {lab=VSS}
N 680 -110 680 -70 {lab=VSS}
N 680 -210 680 -170 {lab=#net1}
N 710 -210 710 -170 {lab=VSS}
N 880 -260 920 -260 {lab=#net2}
N 880 -400 920 -400 {lab=#net3}
N 880 -280 1050 -280 {lab=#net4}
N 1050 -280 1050 -200 {lab=#net4}
N 880 -300 1090 -300 {lab=#net5}
N 1090 -300 1090 -200 {lab=#net5}
N 880 -320 1130 -320 {lab=#net6}
N 1130 -320 1130 -200 {lab=#net6}
N 880 -340 1170 -340 {lab=#net7}
N 1170 -340 1170 -200 {lab=#net7}
N 880 -360 1210 -360 {lab=#net8}
N 1210 -360 1210 -200 {lab=#net8}
N 880 -380 1250 -380 {lab=#net9}
N 1250 -380 1250 -200 {lab=#net9}
...
write current_reference_generator_v2_TB_temp.raw

* Temp results
setplot dc1
let id_n2 = @m.x2.xm1.m0[id]
let id_n20 = @m.x2.xm2.m0[id]
let id_n50 = @m.x2.xm3.m0[id]
let id_p2 = @m.x2.xm4.m0[id]
let id_p20 = @m.x2.xm5.m0[id]
let id_p50 = @m.x2.xm6.m0[id]
plot id_n2 id_p2
plot id_n20 id_p20
plot id_n50 id_p50
...
device=resistor
m=1}
C {devices/lab_wire.sym} 710 -170 2 0 {name=p8 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 680 -70 2 1 {name=p9 sig_type=std_logic lab=VSS}
C {lab_pin.sym} 520 -410 2 1 {name=p10 sig_type=std_logic lab=Vref}
C {devices/lab_wire.sym} 680 -490 0 0 {name=p11 sig_type=std_logic lab=VDD}
C {lab_pin.sym} 970 -170 2 1 {name=p12 sig_type=std_logic lab=VDD}
